...
void SolveLQRProblem(const Eigen::MatrixXd &A, const Eigen::MatrixXd &B,
                     ...
                     uint &result_num_iter, double &result_diff, Eigen::MatrixXd *ptr_P_last = nullptr);
...
void SolveLQRProblem(const Eigen::MatrixXd &A, const Eigen::MatrixXd &B,
                     ...
                     Eigen::MatrixXd *ptr_K, uint &result_num_iter,
                     double &result_diff, Eigen::MatrixXd *ptr_P_last = nullptr);
