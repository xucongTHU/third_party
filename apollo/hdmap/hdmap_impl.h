...
#include "third_party/apollo/math/line_segment2d.h"
#include "third_party/apollo/math/polygon2d.h"
#include "third_party/apollo/math/vec2d.h"
#include "third_party/apollo/hdmap/hdmap_common.h"
...
class HDMapImpl {
 ...
 public:
   ...
   * @return 0:success, otherwise failed
   */
  int GetLanes(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetJunctions(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetCrosswalks(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSignals(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetStopSigns(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetYieldSigns(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetClearAreas(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSpeedBumps(const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoads(const apollo::geometry::PointENU& point, double distance,
  ...
  int GetParkingSpaces(
      const apollo::geometry::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLane(const apollo::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLaneWithHeading(const apollo::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetLanesWithHeading(const apollo::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoadBoundaries(const apollo::geometry::PointENU& point, double radius,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoi(const apollo::geometry::PointENU& point, double radius,
  ...
  int GetForwardNearestSignalsOnLane(
      const apollo::geometry::PointENU& point, const double distance,
      std::vector<SignalInfoConstPtr>* signals) const;
   ...
   * @return 0:success, otherwise failed
   */
  int GetLocalMap(const apollo::geometry::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetForwardNearestRSUs(const apollo::geometry::PointENU& point,
                    double distance, double central_heading,
                    double max_heading_difference,
                    std::vector<RSUInfoConstPtr>* rsus) const;

 private:
  int GetLanes(const apollo::math::Vec2d& point, double distance,
               std::vector<LaneInfoConstPtr>* lanes) const;
  int GetJunctions(const apollo::math::Vec2d& point, double distance,
                   std::vector<JunctionInfoConstPtr>* junctions) const;
  int GetCrosswalks(const apollo::math::Vec2d& point, double distance,
                    std::vector<CrosswalkInfoConstPtr>* crosswalks) const;
  int GetSignals(const apollo::math::Vec2d& point, double distance,
                 std::vector<SignalInfoConstPtr>* signals) const;
  int GetStopSigns(const apollo::math::Vec2d& point, double distance,
                   std::vector<StopSignInfoConstPtr>* stop_signs) const;
  int GetYieldSigns(const apollo::math::Vec2d& point, double distance,
                    std::vector<YieldSignInfoConstPtr>* yield_signs) const;
  int GetClearAreas(const apollo::math::Vec2d& point, double distance,
                    std::vector<ClearAreaInfoConstPtr>* clear_areas) const;
  int GetSpeedBumps(const apollo::math::Vec2d& point, double distance,
                    std::vector<SpeedBumpInfoConstPtr>* speed_bumps) const;
  int GetParkingSpaces(
      const apollo::math::Vec2d& point, double distance,
      std::vector<ParkingSpaceInfoConstPtr>* parking_spaces) const;
  int GetPNCJunctions(
      const apollo::math::Vec2d& point, double distance,
      std::vector<PNCJunctionInfoConstPtr>* pnc_junctions) const;
  int GetNearestLane(const apollo::math::Vec2d& point,
                     LaneInfoConstPtr* nearest_lane, double* nearest_s,
                     double* nearest_l) const;
  int GetNearestLaneWithHeading(const apollo::math::Vec2d& point,
                                const double distance,
                                const double central_heading,
                                const double max_heading_difference,
                                LaneInfoConstPtr* nearest_lane,
                                double* nearest_s, double* nearest_l) const;
  int GetLanesWithHeading(const apollo::math::Vec2d& point,
                          const double distance, const double central_heading,
                          const double max_heading_difference,
                          std::vector<LaneInfoConstPtr>* lanes) const;
  int GetRoads(const apollo::math::Vec2d& point, double distance,
               std::vector<RoadInfoConstPtr>* roads) const;

  template <class Table, class BoxTable, class KDTree>
  static void BuildSegmentKDTree(
      const Table& table, const apollo::math::AABoxKDTreeParams& params,
  ...
  static int SearchObjects(const apollo::math::Vec2d& center,
